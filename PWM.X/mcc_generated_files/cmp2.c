...
{           
	...
	DACCTRL1L = 0x80; //CLKDIV 1:1; DACON disabled; DACSIDL disabled; FCLKDIV 1:1; CLKSEL FPLLO - System Clock with PLL Enabled; 
	DACCTRL2L = 0x55; //TMODTIME 85; 
	DACCTRL2H = 0x8A; //SSTIME 138; 
	DAC2CONH = 0x00; //TMCB 0; 
	DAC2CONL = 0xA700; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP2A; DACOEN enabled; 

	//Slope Settings
	SLP2CONH = 0x00; //HME disabled; PSE Negative; SLOPEN disabled; TWME disabled; 
	SLP2CONL = 0x2000; //HCFSEL PWM2H; SLPSTRT None; SLPSTOPB None; SLPSTOPA None; 
	SLP2DAT = 0x0; //SLPDAT 0; 
	DAC2DATL = 0x9C4; //DACDATL 2500; 
	DAC2DATH = 0xFA0; //DACDATH 4000; 
